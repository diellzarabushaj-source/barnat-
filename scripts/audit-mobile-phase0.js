...
const registryCss = read('registry-table-tools.css');
const liteCss = registryCss;
const phase8Css = registryCss;
const designCss = registryCss;
const criticalCss = registryCss;
