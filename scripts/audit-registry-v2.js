...
assert(stylesheetLinks[2] === '/drx-dashboard-stripe.css?v=drx-dashboard-stripe-v8-polish3', 'Shared Stripe shell v8 must load last.');
...
console.log(JSON.stringify({
  ...
  shellVersion:'drx-dashboard-stripe-v8-polish3',
  tableHeaderCount,
