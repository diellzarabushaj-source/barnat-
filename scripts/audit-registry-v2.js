...
assert(/href="\/registry-v2\.css\?v=registry-dose-v6"/.test(html), 'Registry v2 stylesheet is not published.');
assert(/src="\/registry-v2\.js\?v=registry-dose-v6"/.test(html), 'Registry v2 runtime is not published.');
