...
assert(/href="\/registry-v2\.css\?v=profile-columns-v5"/.test(html), 'Registry v2 stylesheet is not published.');
assert(/src="\/registry-v2\.js\?v=profile-columns-v5"/.test(html), 'Registry v2 runtime is not published.');
