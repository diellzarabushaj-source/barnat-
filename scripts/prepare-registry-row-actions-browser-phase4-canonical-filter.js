...
if (!source.includes("formCategory.getAttribute('data-form-category')")) {
  throw new Error('Phase 4 acceptance is missing the canonical pharmaceutical-form category identity.');
}
