...
function patchOfflineRuntime() {
  ...
  if (!source.includes("const SERVICE_WORKER_URL = `/sw.js?v=${RELEASE_ID}`;")
      || !source.includes("const RELEASE_ENDPOINT = '/api/release';")
...
console.log(`Phase 6 single-version runtime active: ${releaseId}. Canonical /offline-runtime.js + /sw.js; legacy paths are migration shims only.`);
