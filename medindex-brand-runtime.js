(() => {
  ...
  const VERSION = 'medindex-brand-v3';
  const PROFILE_VERSION = 'profile-portal-v1';
  const PROFILE_KEY = 'medindex_profile_v1';
  const ROOT = '/public/images/brand/';
  const ASSETS = Object.freeze({
    fullLight:`${ROOT}medindex-full-on-light.png`, fullDark:`${ROOT}medindex-full-on-dark.png`,
    iconLight:`${ROOT}medindex-icon-on-light.png`, iconDark:`${ROOT}medindex-icon-on-dark.png`,
  });
