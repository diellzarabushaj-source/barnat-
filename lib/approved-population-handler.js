...
const DEFAULT_OVERRIDE_SETS = [populationOverrides1to500, populationOverrides501to600];
...
async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({
      ...
      overrideGeneratedAt:clean(populationOverrides501to600?.source?.generatedAt),
      overrideRange:'1-600',
