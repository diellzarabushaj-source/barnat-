...
const populationOverrides1601to1700 = require('../data/approved-population-overrides-1601-1700.json');
const populationOverrides1701to1800 = require('../data/approved-population-overrides-1701-1800.json');
const populationOverrides1801to1900 = require('../data/approved-population-overrides-1801-1900.json');
...
const DEFAULT_OVERRIDE_SETS = [
  ...
  populationOverrides1601to1700,
  populationOverrides1701to1800,
  populationOverrides1801to1900,
];
...
async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({
      ...
      overrideGeneratedAt:clean(populationOverrides1801to1900?.source?.generatedAt),
      overrideRange:'1-1900',
