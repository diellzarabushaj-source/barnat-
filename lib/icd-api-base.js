...
function mapEntry(row, urgentCodes, criticalCodes) {
  ...
  return {
    ...
    englishTitle:clean(row['Emri në anglisht']), latinTitle:clean(row['Emri në latinisht'] || row['Emri Latin'] || row.Latin),
    primaryCare:clean(row['Mjekësi familjare']), emergency:clean(row.Urgjencë),
