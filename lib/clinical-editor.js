...
function normalizeProfilePayload(payload, actor = null) {
...
async function saveDrugEditor(payload, actor = null) {
  ...
  const profile = normalizeProfilePayload(payload, actor);
...
module.exports = {
  ...
  _test:{ bodySize, parseIndications, normalizeDosePayload, normalizeProfilePayload, sameOrigin, auditActor, requireEditorAdmin },
};
