...
function classify(row = {}) {
  ...
  /* Çdo cap i konfiguruar pjesërisht ose me semantikë të papajtueshme është
     bllokues. Motori nuk lejohet ta injorojë një tavan që duket se ekziston. */
...
module.exports = {
  ...
  classify,
  summarize,
  _test:{ blockingStatus, volumeCapability, capsOf, capState, numeric },
};
