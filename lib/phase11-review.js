...
module.exports = {
  handle,
  _test:{ sameOrigin, queryValue, rpcData, bodyObject, requireAttestation, integer, uuid, applyReviewAction, workbench, regimenPacket, identityPacket, clinicalBatchPacket, indicationPacket, adjustmentPacket, publicationPacket },
};
