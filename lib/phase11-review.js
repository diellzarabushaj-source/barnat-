...
async function workbench() {
  return rpc('drx_phase11_review_workbench_v1');
}
...
async function identityPacket(signature) {
  ...
  return rpc('drx_phase11_identity_batch_packet_v1', { p_composition_signature:signature });
}
...
module.exports = {
  handle,
  _test:{ sameOrigin, queryValue, rpcData, workbench, regimenPacket, identityPacket },
};
