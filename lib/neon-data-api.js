...
async function supabaseRequest(path, options = {}) {
  if (!SUPABASE_PUBLISHABLE_KEY) throw new Error('Supabase publishable key is not available.');
...
module.exports = {
  ...
  maximumReadRows,
  _test:{ relationFromPath, isSupabaseMedicalRelation, shouldUseSupabaseRead },
};
