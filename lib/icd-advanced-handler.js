...
function meta(dataset, loaded = {}) {
  return {
    ...
    search:{
      version:'sq-clinical-search-v4',
      engine:'clinical-ranking-v6',
      supports:[
...
function send(req, res, payload, loaded, startedAt) {
  ...
  res.setHeader('X-MedIndex-Search-Version', 'sq-clinical-search-v4');
  res.setHeader('X-MedIndex-Search-Engine', 'clinical-ranking-v6');
