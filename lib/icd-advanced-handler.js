...
function meta(dataset, loaded = {}) {
  return {
    ...
    search:{
      version:'sq-clinical-search-v3',
      engine:'clinical-ranking-v5',
      supports:[
        ...
        'category-first', 'family-grouping', 'latin-parent-fallback',
...
function send(req, res, payload, loaded, startedAt) {
  ...
  res.setHeader('X-MedIndex-Search-Version', 'sq-clinical-search-v3');
  res.setHeader('X-MedIndex-Search-Engine', 'clinical-ranking-v5');
