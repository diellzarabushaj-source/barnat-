...
assert.ok(scripts.includes('/sidebar-taxonomy-v3.js?v=sidebar-taxonomy-v5-polish2-lazy'), 'Protokollet shared sidebar runtime is missing');
...
assert.match(js, /medindex-brand-runtime\.js\?v=drx-brand-v7/);
