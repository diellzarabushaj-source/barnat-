...
assert.ok(
  html.indexOf('emergency-learning-flow-v7.css') > html.indexOf('emergency-learning-v4.css'),
  'V7 CSS must load after learning v4 so it can safely refine the UI',
);
assert.ok(
  html.indexOf('emergency-learning-flow-v7.js') > html.indexOf('emergency-learning-v4.js'),
  'V7 JS must load after learning v4 so Testo veten exists before refinement',
);
assert.ok(
  html.indexOf('emergency-learning-flow-v7.js') > html.indexOf('emergency-readiness-v6.js'),
  'V7 JS must load after readiness v6 to be the final learning-flow refinement',
);
