...
assert.match(script, /requested\.has\(clean\(card\?\.registryNumber \?\? card\?\.nr\)\)/, 'dosage client must reject cards outside the requested visible batch');
...
console.log('Registry visible-row Neon dosage batching and deterministic idle reconciliation contract passed.');
