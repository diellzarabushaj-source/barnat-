...
assert.match(loader, /registry-runtime-loader-v3/, 'the cooperative interaction gate version must be current');
assert.match(loader, /FIRST_INTERACTION_FALLBACK_MS = 5000/, 'the registry must retain a bounded automatic fallback without competing with the first interaction');
...
console.log('Registry fast-start, authenticated first-interaction gate v3 and bounded loader audit passed.');
