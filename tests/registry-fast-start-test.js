...
assert.match(loader, /registry-runtime-loader-v4/, 'the completed-interaction gate version must be current');
assert.match(loader, /FIRST_INTERACTION_FALLBACK_MS = 15000/, 'the registry must retain a bounded automatic fallback without competing with the first interaction');
assert.match(loader, /POST_INTERACTION_GRACE_MS = 1500/, 'the completed interaction must settle before heavy startup');
...
console.log('Registry fast-start, completed first-interaction gate v4 and bounded loader audit passed.');
