...
assert(index.includes('registry-cell-preview.js?v=20260801-4'), 'Inline cell expansion controller v5 is not wired.');
assert(
  index.indexOf('registry-cell-preview.js?v=20260801-4') < index.indexOf('registry-row-expand.js?v=20260801-4'),
...
assert(controller.includes("const VERSION = 'registry-cell-preview-20260801-5'"), 'Cell preview runtime version is stale.');
...
console.log('Inline full-cell row expansion v5, release 13 and unified table audit passed.');
