...
assert(index.includes('registry-unified-table.js?v=registry-canonical-main-table-v1'), 'Unified table population controller is not wired.');
assert(
  index.indexOf('registry-unified-table.css?v=registry-canonical-main-table-v1') < index.indexOf('registry-full-text-expansion.css?v=20260805-2'),
