...
assert.equal(suggestion.meta.search.engine, 'clinical-ranking-v8');
...
assert.ok(suggestion.meta.search.supports.includes('qkmf-hot-cache'));
assert.ok(suggestion.meta.search.supports.includes('zero-network-common-preview'));
