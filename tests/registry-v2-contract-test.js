...
assert.doesNotMatch(js, /Të dhënat nga sheet \/ databaza/);
assert.doesNotMatch(js, /canonicalDataFields/);
assert.match(js, /Klasa \/ Çka është/);
assert.match(js, /Doza e strukturuar nuk është e disponueshme për këtë popullatë/);
