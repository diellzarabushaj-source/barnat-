...
assert.match(html, /urgjencat-v2\.css\?v=1/);
assert.match(html, /urgjencat-v2\.js\?v=1/);
...
assert.doesNotMatch(html, /tailadmin-|auth-client|emergency-curriculum|medical-hub\.css|drx-dashboard-stripe/);
