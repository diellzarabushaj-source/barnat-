...
const standalone = ['index.html','klasifikimi.html','icd.html','urgjencat.html','analizat.html','medical-hub.html'];
const tailadmin = ['dozologjia.html','protokollet.html','recetat.html','sistemi.html'];
