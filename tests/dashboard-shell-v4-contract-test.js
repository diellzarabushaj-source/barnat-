...
const standalone = ['index.html','klasifikimi.html','icd.html','urgjencat.html','medical-hub.html'];
const tailadmin = ['analizat.html','dozologjia.html','protokollet.html','recetat.html','sistemi.html'];
