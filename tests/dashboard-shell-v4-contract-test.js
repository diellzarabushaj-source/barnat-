...
const standalone = ['index.html','klasifikimi.html','icd.html','urgjencat.html','analizat.html','protokollet.html','medical-hub.html'];
const tailadmin = ['dozologjia.html','recetat.html','sistemi.html'];
