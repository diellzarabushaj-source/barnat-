...
assert.match(shared, /function initSidebarCollapse\(/);
assert.match(shared, /function setSidebarCollapsed\(/);
assert.match(shared, /function bindCollapsedGroupExpansion\(/);
