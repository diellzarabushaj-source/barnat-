...
assert.equal(snapshot.counts.first100VerifiedProductSources, 79);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 9);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 88.8);
