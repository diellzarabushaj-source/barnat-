...
assert.equal(snapshot.counts.first100VerifiedProductSources, 80);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 8);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 89.9);
