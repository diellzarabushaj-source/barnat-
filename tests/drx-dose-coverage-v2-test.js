...
assert.equal(snapshot.counts.first100VerifiedProductSources, 83);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 5);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 93.3);
