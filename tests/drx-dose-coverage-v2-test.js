...
assert.equal(snapshot.counts.first100VerifiedProductSources, 81);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 7);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 91);
