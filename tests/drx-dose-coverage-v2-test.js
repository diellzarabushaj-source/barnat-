...
assert.equal(snapshot.counts.first100VerifiedProductSources, 73);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 14);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 83);
