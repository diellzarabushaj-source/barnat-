...
assert.equal(snapshot.counts.first100VerifiedProductSources, 76);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 12);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 85.4);
