...
assert.equal(snapshot.counts.first100VerifiedProductSources, 85);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 3);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 95.5);
