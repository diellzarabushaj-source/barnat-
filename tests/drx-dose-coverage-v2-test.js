...
assert.equal(snapshot.counts.first100VerifiedProductSources, 84);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 4);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 94.4);
