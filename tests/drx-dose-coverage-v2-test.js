...
assert.equal(snapshot.counts.first100VerifiedProductSources, 77);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 11);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 86.5);
