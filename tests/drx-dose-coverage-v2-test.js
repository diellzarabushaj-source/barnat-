...
assert.equal(snapshot.counts.first100VerifiedProductSources, 75);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 13);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 84.3);
