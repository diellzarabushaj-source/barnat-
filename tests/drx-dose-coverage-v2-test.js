...
assert.equal(snapshot.counts.first100VerifiedProductSources, 65);
assert.equal(snapshot.counts.first100SourceDiscoveryRemaining, 21);
...
assert.equal(snapshot.first100ProgressPct.verifiedProductSources, 74.7);
