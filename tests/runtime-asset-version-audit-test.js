...
assert.match(index, /data-registry-ui-release="20260805-24"/, 'registry UI release is stale');
...
assert.match(index, /registry-dose-table-button\.js\?v=20260805-4/, 'dose table button runtime is missing');
assert.match(index, /registry-dose-table-button\.css\?v=20260805-3/, 'dose table button stylesheet is missing');
...
console.log('Clinical runtime cache-version, loader v6, mutation-free dose accessibility and full-row reveal asset audit passed.');
