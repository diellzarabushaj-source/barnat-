...
assert.match(index, /data-registry-ui-release="20260805-25"/, 'registry UI release is stale');
...
assert.match(index, /registry-dose-table-button\.css\?v=20260805-4/, 'dose table button stylesheet is missing');
...
console.log('Clinical runtime cache-version, loader v6, canonical dose accessibility and full-row reveal asset audit passed.');
