...
assert.match(index, /data-registry-ui-release="20260805-20"/, 'registry UI release is stale');
...
assert.match(index, /registry-dose-table-button\.js\?v=20260805-1/, 'dose table button runtime is missing');
assert.match(index, /registry-dose-table-button\.css\?v=20260805-1/, 'dose table button stylesheet is missing');
