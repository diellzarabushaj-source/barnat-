...
for (const marker of [
  ...
  'icd-favorites.css?v=icd-favorites-v1', 'icd-favorites.js?v=icd-favorites-v1',
  'id="icdFavoritesToggle"', 'id="icdFavoritesPanel"',
...
assert.ok(
  html.indexOf('icd-prescription-roundtrip.js?v=icd-rx-roundtrip-v1')
    < html.indexOf('icd-favorites.js?v=icd-favorites-v1'),
  'Workspace health must preserve the favorites layer after prescription round-trip.',
);
...
for (const marker of [
  ...
  "'X-MedIndex-ICD-Workspace':'health-v2'", 'validSource',
