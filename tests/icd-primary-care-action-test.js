...
assert.equal(medicationEntries.length, 76);
...
const practicalEntries = Data.entries.filter(entry => entry.practical);
assert.equal(practicalEntries.length, 25);
for (const entry of practicalEntries) {
  assert.ok(Array.isArray(entry.practical.steps) && entry.practical.steps.length >= 4, `Practical steps missing for ${entry.code}`);
  assert.ok(entry.practical.reassess, `Practical reassessment missing for ${entry.code}`);
}
for (const code of ['J06','R05','R50','R19.7','A09','R11','R10.4','R42','R53','R00.2','M54','M54.5','M54.3','M54.2','M47','M51','M25.5','M79.1','R60','H60','H81.1','N40','N76','K64','E66']) {
  assert.ok(Data.entries.find(entry => entry.code === code)?.practical, `Practical workflow missing for ${code}`);
}

for (const code of ['I10','E11','J01','J02','J03','J18','J45','J44','H66','K21','K29','K30','N39.0','N30','G43','L03','L20','L70','D50','E03','F41','F32','M10','E05','B02','J20','J30','R12','K59.0','B35','L30','M19','M17','B37','L01','B00','J32','J04','H00','H01','H61.2','K58','K80','N20','N45','N92','N94.6','G47.0','E78','L50','H10','J06','R05','R50','R19.7','A09','R11','R10.4','R42','R53','R00.2','M54','M54.5','M54.3','M54.2','M47','M51','M25.5','M79.1','R60','H60','H81.1','N40','N76','K64','E66']) {
