...
assert.match(html, /icd-v2\.css\?v=clinical-workspace-v23/);
assert.match(html, /icd-v2\.js\?v=clinical-workspace-v23/);
...
assert.match(js, /sv:'clinical-workspace-v23'/);
...
assert.match(js, /data-clinical-copy="medications"/);
assert.match(js, /data-clinical-copy="practical"/);
assert.match(js, /clinical-action-commandbar/);
assert.match(js, /clinical-action-nav/);
assert.match(js, /event\.preventDefault\(\)/);
assert.match(js, /target\.scrollIntoView\(\{ block:'start', behavior \}\)/);
assert.match(js, /\.clinical-action-nav a\[href\^="#"\]/);
assert.match(js, /clinical-action-stats/);
assert.match(js, /href="#clinicalPractical"/);
assert.match(js, /href="#clinicalMedications"/);
assert.match(js, /id="clinicalManagement"/);
assert.match(js, /id="clinicalHistory"/);
assert.match(js, /id="clinicalExams"/);
assert.match(js, /id="clinicalReferral"/);
assert.match(js, /Si vepron praktikisht/);
assert.match(js, /Hapat në rend/);
assert.match(js, /Rivlerëso/);
assert.match(js, /Barnat \/ terapia/);
assert.match(js, /Çka përdoret konkretisht/);
assert.match(js, /clinicalCopyText\('medications', guidance\)/);
...
assert.match(css, /\.clinical-action-card\.is-medications/);
assert.match(css, /\.clinical-medication-block/);
assert.match(css, /\.clinical-medication-evidence/);
assert.match(css, /\.clinical-action-card\.is-practical/);
assert.match(css, /\.clinical-practical-steps/);
assert.match(css, /\.clinical-reassess/);
assert.match(css, /Clinical workspace polish v21/);
assert.match(css, /Extreme responsive pass v22/);
assert.match(css, /Premium finish v23/);
assert.match(css, /--icd-premium-shadow/);
assert.match(css, /radial-gradient\(circle at 12% 0/);
assert.match(css, /\.clinical-action-card\.is-referral/);
assert.match(css, /\.clinical-action-card\.is-summary/);
assert.match(css, /@media\(hover:hover\) and \(pointer:fine\)/);
assert.match(css, /outline:2px solid #7568df/);
assert.match(css, /scroll-snap-type:x proximity/);
assert.match(css, /\.chapter-list::-webkit-scrollbar/);
assert.match(css, /\.metrics-row::-webkit-scrollbar/);
assert.match(css, /position:sticky;top:50px/);
...
assert.match(css, /\.clinical-action-commandbar/);
assert.match(css, /\.clinical-action-nav/);
assert.match(css, /\.clinical-action-stats/);
