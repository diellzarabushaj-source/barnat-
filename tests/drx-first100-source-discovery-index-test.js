...
assert.equal(x.verifiedProductSpecific,84);
assert.equal(x.productSelectionRequired,1);
assert.equal(x.verifiedCanonicalSubstances,84);
...
assert.equal(x.eligibleRemaining,5);
assert.equal(x.sourceLookupRemaining,4);
