...
assert.equal(x.verifiedProductSpecific,85);
assert.equal(x.productSelectionRequired,1);
assert.equal(x.verifiedCanonicalSubstances,85);
...
assert.equal(x.eligibleRemaining,4);
assert.equal(x.sourceLookupRemaining,3);
