...
assert.equal(x.verifiedProductSpecific,80);
assert.equal(x.productSelectionRequired,1);
assert.equal(x.verifiedCanonicalSubstances,80);
...
assert.equal(x.eligibleRemaining,9);
assert.equal(x.sourceLookupRemaining,8);
