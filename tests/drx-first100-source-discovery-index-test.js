...
assert.equal(x.verifiedProductSpecific,79);
assert.equal(x.productSelectionRequired,1);
assert.equal(x.verifiedCanonicalSubstances,79);
...
assert.equal(x.eligibleRemaining,10);
assert.equal(x.sourceLookupRemaining,9);
