...
assert.equal(x.verifiedProductSpecific,76);
assert.equal(x.productSelectionRequired,1);
assert.equal(x.verifiedCanonicalSubstances,76);
...
assert.equal(x.eligibleRemaining,13);
assert.equal(x.sourceLookupRemaining,12);
