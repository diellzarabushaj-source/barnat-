...
assert.equal(x.verifiedProductSpecific,75);
assert.equal(x.productSelectionRequired,1);
assert.equal(x.verifiedCanonicalSubstances,75);
...
assert.equal(x.eligibleRemaining,14);
assert.equal(x.sourceLookupRemaining,13);
