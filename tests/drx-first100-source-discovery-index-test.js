...
assert.equal(x.verifiedProductSpecific,83);
assert.equal(x.productSelectionRequired,1);
assert.equal(x.verifiedCanonicalSubstances,83);
...
assert.equal(x.eligibleRemaining,6);
assert.equal(x.sourceLookupRemaining,5);
