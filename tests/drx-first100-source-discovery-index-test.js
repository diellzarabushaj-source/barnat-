...
assert.equal(x.verifiedProductSpecific,81);
assert.equal(x.productSelectionRequired,1);
assert.equal(x.verifiedCanonicalSubstances,81);
...
assert.equal(x.eligibleRemaining,8);
assert.equal(x.sourceLookupRemaining,7);
