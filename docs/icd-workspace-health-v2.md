...
- Terminologjia, provenance dhe transferi i strukturuar në recetë mbeten të paprekura.
...
- Ka maksimum një retry për `408`, `429`, `500`, `502`, `503`, `504` ose gabim rrjeti.
...
- Një test i dytë simulon `503`, kërkon saktësisht një retry dhe konfirmon që tree mbetet i përdorshëm.
