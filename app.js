...
(async () => {
  ...
  async function loadGoogleDriveFallback({ background = false } = {}) {
    ...
    try {
      const registryResponse = await fetch('/api/registry?fallback=1&version=20260722-11', {
        cache: 'no-store',
      });
  ...
  const files = [
    './app-parts/part-01.txt?v=20260722-11',
    './app-parts/part-02.txt?v=20260722-11',
    './app-parts/part-03.txt?v=20260722-11',
    './app-parts/part-04.txt?v=20260722-11',
    './app-parts/part-05.txt?v=20260722-11',
    './app-parts/part-06.txt?v=20260722-11',
    './app-parts/part-07.txt?v=20260722-11',
  ];
