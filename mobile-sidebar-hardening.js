(() => {
  ...
  const VERSION = 'mobile-sidebar-deep-audit-v5';
  ...
  function syncState() {
    ...
    const sidebarStateChanged = previousMobileOpen !== mobileOpen;
    const panel = sidebar();
    ...
    if (sidebarStateChanged) window.MedIndexRegistryMobilePhase3?.syncNavigation?.();
  }
