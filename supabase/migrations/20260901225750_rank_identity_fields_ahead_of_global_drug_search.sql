-- Runtime history backfill for the applied identity-ranking migration.
-- Identity fields (trade name, substance, strength, form) rank ahead of broader clinical prose.
