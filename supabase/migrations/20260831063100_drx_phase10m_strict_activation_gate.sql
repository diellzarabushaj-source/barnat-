...
begin
  ...
  -- LEGACY_CONSUMERS_ZERO is deliberately a post-strict retirement gate.
  -- Requiring it here would deadlock cutover because V2 consumers must remain
  -- available during CONTROLLED traffic and can become unreachable only after
  -- STRICT routes all dose traffic to V3.
