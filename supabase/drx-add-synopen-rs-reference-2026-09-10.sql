...
WITH upsert_drug AS (
  INSERT INTO public.drugs (
    ...
    'For acute allergic reactions, including urticaria, angioedema, drug hypersensitivity, insect-bite/sting reactions and hay fever, according to the cited Serbian product information.',
    'published',
    true,
    '10 ampoules x 2 mL',
